...
- **OpenGrep** (optional; download a pinned release from the [official releases page](https://github.com/opengrep/opengrep/releases) — avoid piping install scripts to a shell without reviewing them first)
- **Git**
