...
Model `gpt-5.5` · temp `0` · panel `sha256:7d1c6808c…` · 2026-07-11T06:46:31

precision **93%** · recall **90%** · TP 41 (real 38, false-alarm 3) · real 42 · not-real 29 · NMD 1 · err 0 · $11.4047
_resources:_ 1.31M in / 292k out · cache 66% · 5749.1s model-time · iters μ3.3

| finding | truth | verdict | grade | conf |
|---|---|---|---|---|
| javascript.browser.security.eval-detected.eval-detected@vulnerabilities/javascript/source/high.js:1 | not-real | FP | CORRECT | Medium |
...
| php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/fi/source/high.php:7 | not-real | FP | CORRECT | High |
| php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_help.php:20 | real | TP | CORRECT | High |
| php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_help.php:22 | real | TP | CORRECT | Medium |
| php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source_all.php:14 | real | TP | CORRECT | Medium |
| php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source_all.php:18 | real | FP | MISS | Medium |
...
| php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source_all.php:26 | real | FP | MISS | Low |
| php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source.php:63 | real | TP | CORRECT | High |
| php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source.php:67 | real | FP | MISS | Low |
...
| php.lang.security.injection.tainted-sql-string.tainted-sql-string@vulnerabilities/bac/source/low.php:35 | not-real | FP | CORRECT | Low |
...
| php.lang.security.md5-loose-equality.md5-loose-equality@vulnerabilities/cryptography/source/ecb_attack.php:92 | not-real | NMD | abstain | Medium |
...
| php.lang.security.md5-loose-equality.md5-loose-equality@vulnerabilities/javascript/index.php:57 | not-real | FP | CORRECT | Low |
| php.lang.security.php-permissive-cors.php-permissive-cors@vulnerabilities/api/gen_openapi.php:6 | not-real | TP | FALSE-ALARM | Medium |
| php.lang.security.php-permissive-cors.php-permissive-cors@vulnerabilities/api/public/index.php:11 | not-real | FP | CORRECT | Low |
| php.lang.security.phpinfo-use.phpinfo-use@phpinfo.php:8 | real | TP | CORRECT | High |
...
| yaml.github-actions.security.run-shell-injection.run-shell-injection@.github/workflows/docker-image.yml:29 | not-real | FP | CORRECT | Medium |
