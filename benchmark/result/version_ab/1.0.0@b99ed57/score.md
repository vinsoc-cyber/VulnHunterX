...
Model `gpt-5.5` · temp `0` · 2026-07-11T06:46:31

precision **94%** · recall **88%** · TP 82 (real 77, false-alarm 5) · real 88 · not-real 37 · NMD 4 · err 0 · $16.6717
_resources:_ 1.93M in / 426k out · cache 66% · 9025.2s model-time · iters μ2.76
...
| dvwa | javascript.browser.security.eval-detected.eval-detected@vulnerabilities/javascript/source/high.js:1 | not-real | FP | CORRECT | Medium |
...
| dvwa | php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_help.php:22 | real | TP | CORRECT | Medium |
| dvwa | php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source_all.php:14 | real | TP | CORRECT | Medium |
...
| dvwa | php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source_all.php:26 | real | FP | MISS | Low |
...
| dvwa | php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source.php:67 | real | FP | MISS | Low |
...
| dvwa | php.lang.security.injection.tainted-sql-string.tainted-sql-string@vulnerabilities/bac/source/low.php:35 | not-real | FP | CORRECT | Low |
...
| dvwa | php.lang.security.php-permissive-cors.php-permissive-cors@vulnerabilities/api/public/index.php:11 | not-real | FP | CORRECT | Low |
...
| dvwa | yaml.github-actions.security.run-shell-injection.run-shell-injection@.github/workflows/docker-image.yml:29 | not-real | FP | CORRECT | Medium |
...
| insecure-coding-examples | cpp/overflow-buffer@practice/if_constexpr.cpp:15 | real | TP | CORRECT | Medium |
...
| insecure-coding-examples | cpp/static-buffer-overflow@practice/if_constexpr.cpp:15 | real | TP | CORRECT | Medium |
...
| insecure-coding-examples | cpp/type-confusion@practice/guidelines/expressions_and_statements/use_named_cast.cpp:13 | not-real | NMD | abstain | Medium |
...
| nodegoat | js/code-injection@app/data/allocations-dao.js:78 | real | FP | MISS | Low |
...
| nodegoat | js/missing-rate-limiting@app/routes/index.js:34 | real | NMD | abstain | High |
| nodegoat | js/missing-token-validation@server.js:78 | real | FP | MISS | Low |
| nodegoat | js/polynomial-redos@app/routes/profile.js:61 | real | TP | CORRECT | Medium |
| nodegoat | js/polynomial-redos@app/routes/session.js:181 | real | FP | MISS | Low |
| nodegoat | js/redos@app/routes/profile.js:59 | real | TP | CORRECT | High |
| nodegoat | js/request-forgery@app/routes/research.js:16 | real | TP | CORRECT | Medium |
...
| nodegoat | js/sql-injection@app/data/user-dao.js:104 | real | FP | MISS | Low |
| nodegoat | js/sql-injection@app/data/user-dao.js:91 | real | FP | MISS | Low |
...
| dvwa | 93% | 90% | 41 (38/3) | 42 | 29 | 1 | 0 | sha256:7d1c6808c… |
| insecure-coding-examples | 96% | 96% | 26 (25/1) | 26 | 6 | 2 | 0 | sha256:9cdeda155… |
| nodegoat | 100% | 62% | 10 (10/0) | 16 | 1 | 1 | 0 | sha256:1179d5607… |

## Per target — resources
| target | in-tok | out-tok | cache% | time(s) | itersμ | cost |
|---|---|---|---|---|---|---|
| dvcp | 26k | 8k | 29% | 168.5 | 1.2 | $0.3269 |
| dvwa | 1.31M | 292k | 66% | 5749.1 | 3.3 | $11.4047 |
| insecure-coding-examples | 144k | 43k | 61% | 1287.1 | 1.25 | $1.6076 |
| nodegoat | 451k | 83k | 70% | 1820.5 | 3.82 | $3.3324 |
