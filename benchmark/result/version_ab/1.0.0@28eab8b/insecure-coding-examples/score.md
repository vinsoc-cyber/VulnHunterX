...
Model `gpt-5.5` · temp `0` · panel `sha256:9cdeda155…` · 2026-07-12T12:21:06

precision **92%** · recall **88%** · TP 25 (real 23, false-alarm 2) · real 26 · not-real 6 · NMD 0 · err 0 · $1.5952
_resources:_ 162k in / 45k out · cache 75% · 1050.2s model-time · iters μ1.31
...
| cpp/signed-overflow-check@exploitable/undefined_behavior.cpp:11 | not-real | FP | CORRECT | Medium |
...
| cpp/static-buffer-overflow@practice/if_constexpr.cpp:15 | real | FP | MISS | Medium |
...
| cpp/type-confusion@practice/guidelines/expressions_and_statements/use_named_cast.cpp:13 | not-real | TP | FALSE-ALARM | Medium |
| cpp/type-confusion@practice/guidelines/expressions_and_statements/use_named_cast.cpp:16 | not-real | TP | FALSE-ALARM | Low |
