...
Model `gpt-5.5` · temp `0` · 2026-07-11T08:37:30

precision **92%** · recall **97%** · TP 92 (real 85, false-alarm 7) · real 88 · not-real 37 · NMD 4 · err 0 · $16.3515
_resources:_ 1.95M in / 417k out · cache 67% · 8703.6s model-time · iters μ2.76
...
| dvwa | php.lang.security.injection.tainted-exec.tainted-exec@vulnerabilities/api/src/HealthController.php:88 | real | TP | CORRECT | Low |
...
| dvwa | php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source.php:63 | real | TP | CORRECT | Medium |
...
| dvwa | php.lang.security.injection.tainted-sql-string.tainted-sql-string@vulnerabilities/bac/source/low.php:35 | not-real | NMD | abstain | High |
...
| dvwa | php.lang.security.injection.tainted-sql-string.tainted-sql-string@vulnerabilities/bac/source/medium.php:28 | not-real | TP | FALSE-ALARM | High |
...
| dvwa | php.lang.security.php-permissive-cors.php-permissive-cors@vulnerabilities/api/gen_openapi.php:6 | not-real | FP | CORRECT | Low |
...
| nodegoat | js/code-injection@app/data/allocations-dao.js:78 | real | NMD | abstain | Medium |
...
| dvwa | 91% | 100% | 46 (42/4) | 42 | 29 | 2 | 0 | sha256:7d1c6808c… |
| insecure-coding-examples | 93% | 96% | 27 (25/2) | 26 | 6 | 1 | 0 | sha256:9cdeda155… |
| nodegoat | 100% | 88% | 14 (14/0) | 16 | 1 | 1 | 0 | sha256:1179d5607… |

## Per target — resources
| target | in-tok | out-tok | cache% | time(s) | itersμ | cost |
|---|---|---|---|---|---|---|
| dvcp | 26k | 8k | 55% | 196.8 | 1.2 | $0.2944 |
| dvwa | 1.32M | 286k | 68% | 6029.9 | 3.32 | $11.1652 |
| insecure-coding-examples | 139k | 41k | 63% | 841.6 | 1.22 | $1.5357 |
| nodegoat | 463k | 82k | 68% | 1635.2 | 3.76 | $3.3562 |
