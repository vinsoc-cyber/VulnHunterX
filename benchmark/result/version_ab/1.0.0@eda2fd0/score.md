...
Model `gpt-5.5` · temp `0` · 2026-07-01T06:28:53

precision **83%** · recall **81%** · TP 86 (real 71, false-alarm 15) · real 88 · not-real 37 · NMD 5 · err 0 · $17.0537
_resources:_ 1.83M in / 429k out · cache 60% · 16209.5s model-time · iters μ2.9
...
| dvcp | cpp/path-injection@imgRead.c:132 | not-real | TP | FALSE-ALARM | High |
...
| dvwa | javascript.lang.security.audit.detect-non-literal-regexp.detect-non-literal-regexp@vulnerabilities/javascript/source/high.js:1 | not-real | FP | CORRECT | High |
| dvwa | php.lang.security.audit.openssl-decrypt-validate.openssl-decrypt-validate@vulnerabilities/api/src/Token.php:39 | not-real | TP | FALSE-ALARM | Medium |
| dvwa | php.lang.security.eval-use.eval-use@vulnerabilities/view_help.php:20 | real | TP | CORRECT | Low |
...
| dvwa | php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_help.php:20 | real | FP | MISS | High |
| dvwa | php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_help.php:22 | real | FP | MISS | High |
...
| dvwa | php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source_all.php:18 | real | FP | MISS | Medium |
...
| dvwa | php.lang.security.injection.tainted-filename.tainted-filename@vulnerabilities/view_source.php:67 | real | FP | MISS | Medium |
...
| dvwa | php.lang.security.injection.tainted-sql-string.tainted-sql-string@vulnerabilities/sqli_blind/source/high.php:33 | real | FP | MISS | Low |
...
| dvwa | php.lang.security.injection.tainted-sql-string.tainted-sql-string@vulnerabilities/sqli_blind/source/low.php:32 | real | FP | MISS | Low |
| dvwa | php.lang.security.injection.tainted-sql-string.tainted-sql-string@vulnerabilities/sqli_blind/source/medium.php:34 | real | FP | MISS | Low |
...
| dvwa | php.lang.security.md5-loose-equality.md5-loose-equality@vulnerabilities/javascript/index.php:57 | not-real | TP | FALSE-ALARM | Low |
...
| dvwa | php.lang.security.phpinfo-use.phpinfo-use@phpinfo.php:8 | real | TP | CORRECT | High |
...
| dvwa | php.lang.security.unlink-use.unlink-use@vulnerabilities/upload/source/impossible.php:54 | not-real | FP | CORRECT | Low |
...
| insecure-coding-examples | cpp/signed-overflow-check@practice/if_constexpr.cpp:14 | real | TP | CORRECT | High |
| insecure-coding-examples | cpp/static-buffer-overflow@practice/if_constexpr.cpp:15 | real | TP | CORRECT | High |
| insecure-coding-examples | cpp/suspicious-sizeof@practice/decay.cpp:5 | not-real | TP | FALSE-ALARM | Low |
| insecure-coding-examples | cpp/suspicious-sizeof@practice/guidelines/expressions_and_statements/cautious_pointer_use_decay.cpp:10 | not-real | TP | FALSE-ALARM | Low |
...
| insecure-coding-examples | cpp/type-confusion@practice/guidelines/expressions_and_statements/use_named_cast.cpp:16 | not-real | FP | CORRECT | Medium |
...
| nodegoat | js/clear-text-cookie@server.js:78 | real | NMD | abstain | High |
...
| nodegoat | js/code-injection@app/routes/contributions.js:33 | real | TP | CORRECT | Low |
| nodegoat | js/code-injection@app/routes/contributions.js:34 | real | TP | CORRECT | Medium |
...
| nodegoat | js/missing-rate-limiting@app/routes/index.js:34 | real | NMD | abstain | Medium |
| nodegoat | js/missing-token-validation@server.js:78 | real | FP | MISS | Medium |
| nodegoat | js/polynomial-redos@app/routes/profile.js:61 | real | TP | CORRECT | High |
| nodegoat | js/polynomial-redos@app/routes/session.js:181 | real | TP | CORRECT | Low |
| nodegoat | js/redos@app/routes/profile.js:59 | real | NMD | abstain | Medium |
...
| nodegoat | js/session-fixation@app/routes/index.js:34 | real | TP | CORRECT | Low |
| nodegoat | js/sql-injection@app/data/user-dao.js:104 | real | NMD | abstain | High |
| nodegoat | js/sql-injection@app/data/user-dao.js:91 | real | NMD | abstain | High |
...
| dvwa | 78% | 74% | 40 (31/9) | 42 | 29 | 0 | 0 | sha256:7d1c6808c… |
| insecure-coding-examples | 87% | 100% | 30 (26/4) | 26 | 6 | 0 | 0 | sha256:9cdeda155… |
| nodegoat | 91% | 62% | 11 (10/1) | 16 | 1 | 5 | 0 | sha256:1179d5607… |

## Per target — resources
| target | in-tok | out-tok | cache% | time(s) | itersμ | cost |
|---|---|---|---|---|---|---|
| dvcp | 23k | 8k | 43% | 288.9 | 1.2 | $0.2969 |
| dvwa | 1.23M | 287k | 63% | 10825.5 | 3.44 | $11.2915 |
| insecure-coding-examples | 128k | 43k | 54% | 1635.4 | 1.22 | $1.631 |
| nodegoat | 447k | 91k | 57% | 3459.7 | 4.29 | $3.8343 |
